...
function getImageForCharacter(character) {
  ...
  if (image) {
    ...
    console.error(
      `Error loading image for character "${character}": Image not found`
    );
...
const TextToSign = () => {
  ...
  return (
    <>
      {" "}
      <h1 className="text-center text-3xl font-bold text-neutral mt-8">
        Text-To-Sign
      </h1>
      <div className="flex items-center justify-center h-screen bg-transparent">
        <div className="bg-white -mt-44 font-semibold text-center rounded-3xl border shadow-lg p-10 max-w-xs h-2/3 min-w-[90%] md:min-w-[70%]">
          ...
          <div className="flex flex-col gap-0 w-full justify-center items-center customMarginTop">
            ...
            <button
              className="bg-bakground text-light px-8 py-2 mt-2 w-44 rounded-md font-semibold uppercase tracking-wide"
